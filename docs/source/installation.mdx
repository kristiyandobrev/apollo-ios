...
Code generation uses your `.graphql` files to generate API code that will help you send queries, subscriptions, and mutations, as well as parse and cache responses.

To set this up, please follow the instructions in the [Swift Codegen Setup](codegen-setup) section. 
